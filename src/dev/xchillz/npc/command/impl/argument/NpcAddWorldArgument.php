...
final class NpcAddWorldArgument extends Argument {
    ...
    public function onPlayerExecute(
        ...
        if (!isset($args[0], $args[1])) {
            $player->sendMessage($this->getMessagesConfig()->getMessage('npc.add.world.usage', []));
            return;
        }
        ...
        $npc->addWorld($worldId);
        
        $player->sendMessage($this->getMessagesConfig()->getMessage('npc.add.world.success', ['id' => $npcId, 'world' => $worldId]));
    }
